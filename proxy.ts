...
function buildCsp(request: NextRequest) {
  ...
  const directives = [
    ...
    `connect-src 'self' ${siteOrigin} https://api.groq.com https://api-inference.huggingface.co https://api.cloudinary.com https://firestore.googleapis.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://*.googleapis.com https://*.firebaseapp.com https://www.googleapis.com https://www.gstatic.com`,
