  ...
  return (
    <div className="space-y-6">
      <motion.div
        ...
        className="paper-card p-8 shadow-none"
      >
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-black tracking-tight text-[var(--foreground)]">Homepage Content</h2>
          <motion.button
            whileHover={{ scale: 1.05 }}
            onClick={() => setEditMode(!editMode)}
            className="paper-button-primary flex items-center gap-2 px-4 py-2"
          >
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-semibold text-[var(--foreground)]/75 mb-2">Hero Title</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-semibold text-[var(--foreground)]/75 mb-2">Hero Subtitle</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-semibold text-[var(--foreground)]/75 mb-2">Hero Tagline</label>
            <input
              type="text"
