      ...
      <div className="paper-card flex items-center gap-3 p-4 shadow-none md:p-5">
        ...
        <div>
          ...
          <p className="text-sm text-[var(--foreground)]/65">
            A quick summary of live admin activity and portfolio content.
          </p>
        </div>
      </div>

      <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-4 md:gap-6">
        {[
          ...
          >
            <div className="text-xs font-semibold uppercase tracking-[0.18em] text-[var(--foreground)]/55">
              {stat.label}
            </div>
