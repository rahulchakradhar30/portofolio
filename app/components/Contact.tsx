...
export default function Contact() {
  ...
  return (
    <section className="py-16 md:py-24 px-4 md:px-8 bg-gradient-to-br from-violet-50 to-pink-50 relative overflow-hidden" id="contact">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16">
          ...
          >
            ...
            <div className="space-y-4 md:space-y-6">
              <motion.div
                ...
                className="flex items-center p-3 md:p-4 bg-white rounded-xl md:rounded-2xl shadow-md hover:shadow-lg transition-shadow border border-white/50"
              >
                <div className="w-10 md:w-12 h-10 md:h-12 bg-gradient-to-br from-pink-400 to-rose-400 rounded-lg md:rounded-xl flex items-center justify-center mr-3 md:mr-4 flex-shrink-0">
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-gray-600 text-xs md:text-sm truncate">rahulchakradharperepogu@gmail.com</div>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                className="flex items-center p-3 md:p-4 bg-white rounded-xl md:rounded-2xl shadow-md hover:shadow-lg transition-shadow border border-white/50"
              >
                <div className="w-10 md:w-12 h-10 md:h-12 bg-gradient-to-br from-green-400 to-emerald-400 rounded-lg md:rounded-xl flex items-center justify-center mr-3 md:mr-4 flex-shrink-0">
                ...
                <div>
                  ...
                  <div className="text-gray-600 text-xs md:text-sm">Bengaluru, Karnataka</div>
                </div>
              </motion.div>
            </div>
            ...
            <div className="pt-6 md:pt-8">
              ...
              <div className="flex gap-3 md:gap-4">
                <motion.a
                  ...
                  className="w-10 md:w-12 h-10 md:h-12 bg-gradient-to-br from-pink-400 to-pink-600 rounded-lg md:rounded-xl flex items-center justify-center text-white shadow-lg hover:shadow-xl transition-all duration-300 flex-shrink-0"
                ...
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 md:w-12 h-10 md:h-12 bg-gradient-to-br from-blue-400 to-blue-600 rounded-lg md:rounded-xl flex items-center justify-center text-white shadow-lg hover:shadow-xl transition-all duration-300 flex-shrink-0"
                ...
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 md:w-12 h-10 md:h-12 bg-gradient-to-br from-gray-700 to-gray-900 rounded-lg md:rounded-xl flex items-center justify-center text-white shadow-lg hover:shadow-xl transition-all duration-300 flex-shrink-0"
          ...
          <motion.form
            ...
            className="bg-white p-4 md:p-8 rounded-2xl md:rounded-3xl shadow-lg md:shadow-2xl border border-white/50"
          >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-3 md:px-4 py-2 md:py-3 border border-gray-200 rounded-lg md:rounded-xl focus:ring-2 focus:ring-violet-500 focus:border-transparent bg-gray-50 focus:bg-white transition-all duration-200 text-sm md:text-base"
                    placeholder="John"
                  />
                </div>
                <div>
